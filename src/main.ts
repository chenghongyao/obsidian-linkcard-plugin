...
export class BilibiliBlock extends MarkdownRenderChild {
	...
	onload() {
		...
		wrapperEl.innerHTML = `<iframe src="https://player.bilibili.com/player.html?bvid=${this.id}&page=1&high_quality=1&as_wide=1&allowfullscreen=true&autoplay=0" frameborder="no" allowfullscreen sandbox="allow-top-navigation-by-user-activation allow-same-origin allow-forms allow-scripts allow-popups" class="" style="width: 100%; height:100%" ></iframe>`;
		this.containerEl.replaceWith(wrapperEl);
	}
}
